...
import ro.cc.ShopApp;

import ro.cc.domain.ProductCategory;
import ro.cc.repository.ProductCategoryRepository;
import ro.cc.repository.search.ProductCategorySearchRepository;
import ro.cc.web.rest.errors.ExceptionTranslator;
...
import static ro.cc.web.rest.TestUtil.createFormattingConversionService;
...
public class ProductCategoryResourceIntTest {
    ...
    /**
     * This repository is mocked in the ro.cc.repository.search test package.
     *
     * @see ro.cc.repository.search.ProductCategorySearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        final ProductCategoryResource productCategoryResource = new ProductCategoryResource(productCategoryRepository, mockProductCategorySearchRepository);
